...
import com.tianxian.core.ui.AppRoot
import com.tianxian.core.ui.onboarding.Onboarding
import com.tianxian.core.ui.theme.CoreTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val graph = (application as GraphHolder).graph
        ...
        setContent {
            ...
            CoreTheme(theme = theme) {
                if (!onboarded) {
                    Onboarding(appName = graph.config.appName, onFinish = { settings.onboarded = true; onboarded = true })
                } else {
